...
begin
   ...
   if Form1.CheckBox5.Checked then begin
     ...
     if MessageDlg('cmd.exe /c ' + Form1.Edit1.Text + NewText + Form1.Edit2.Text + LineEnding + 'Do you want to continue?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then begin  //Display Command in Debug Mode and ask for Confrmation
